...
describe('User sign up proof (Airdrop proof) events in Unirep State', function () {
    ...
    describe('Airdrop proof event', async () => {
        ...
        it('submit airdrop proof event', async () => {
            ...
            const circuitInputs = await (0, utils_1.genProveSignUpCircuitInput)(userIds[userIdx], epoch, GSTree, userIdx, reputationRecords, BigInt(attesterId));
            ...
            await (0, chai_1.expect)(unirepContractCalledByAttester.airdropEpochKey(airdropProofInput))
