...
declare class EpochKeyProof implements IEpochKeyProof {
  ...
  epochKey: Field;
  proof: Field[];
  private readonly publicSignals;
...
declare const computeStartTransitionProofHash: (
  blindedUserState: Field,
  blindedHashChain: Field,
  globalStateTree: Field,
  proof: Field[]
) => string;
declare const computeProcessAttestationsProofHash: (
  outputBlindedUserState: Field,
  outputBlindedHashChain: Field,
  inputBlindedUserState: Field,
  proof: Field[]
) => string;
declare const deployUnirep: (
  deployer: ethers.Signer,
  _treeDepths: any,
  _settings?: any
) => Promise<Unirep>;
declare const getUnirepContract: (
