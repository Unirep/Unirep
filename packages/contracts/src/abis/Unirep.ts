export const UnirepABI = [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint8', name: 'userStateTreeDepth', type: 'uint8' },
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'maxAttesters', type: 'uint256' },
        ],
      ...
      { internalType: 'uint8', name: '_maxReputationBudget', type: 'uint8' },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'posRep', type: 'uint256' },
          { internalType: 'uint256', name: 'negRep', type: 'uint256' },
          { internalType: 'uint256', name: 'graffiti', type: 'uint256' },
          { internalType: 'uint256', name: 'signUp', type: 'uint256' },
        ],
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        components: [
          { internalType: 'uint256', name: 'globalStateTree', type: 'uint256' },
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'proveGraffiti', type: 'uint256' },
          {
            internalType: 'uint256',
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'globalStateTree', type: 'uint256' },
          { internalType: 'uint256', name: 'attesterId', type: 'uint256' },
          { internalType: 'uint256', name: 'userHasSignedUp', type: 'uint256' },
          { internalType: 'uint256[8]', name: 'proof', type: 'uint256[8]' },
        ],
        indexed: false,
    ...
    inputs: [
      ...
      },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'fromEpochTree', type: 'uint256' },
          { internalType: 'uint256[8]', name: 'proof', type: 'uint256[8]' },
        ],
        indexed: false,
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'blindedUserState', type: 'uint256' },
      { internalType: 'uint256', name: 'blindedHashChain', type: 'uint256' },
      { internalType: 'uint256', name: 'globalStateTree', type: 'uint256' },
      { internalType: 'uint256[8]', name: 'proof', type: 'uint256[8]' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'fromProofIndex', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    name: 'treeDepths',
    outputs: [
      { internalType: 'uint8', name: 'globalStateTreeDepth', type: 'uint8' },
      { internalType: 'uint8', name: 'userStateTreeDepth', type: 'uint8' },
      { internalType: 'uint8', name: 'epochTreeDepth', type: 'uint8' },
    ],
    stateMutability: 'view',
  ...
  {
    inputs: [{ internalType: 'uint256[8]', name: 'proof', type: 'uint256[8]' }],
    name: 'unpackProof',
    outputs: [
