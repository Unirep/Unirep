...
export class UserStateTransitionProof extends BaseProof {
    ...
    public epochTransitionNullifier: BigNumberish
    ...
    constructor(
        ...
        this.epochTransitionNullifier =
            _publicSignals[this.idx.epochTransitionNullifier].toString()
