...
contract Hasher is UnirepTypes {
    ...
    function hashReputationProof(ReputationProof memory _input)
        public
        pure
        returns (bytes32)
    {
    ...
    function hashSignUpProof(SignUpProof memory _input)
        public
        pure
        returns (bytes32)
    {
    ...
    function hashUserStateTransitionProof(UserTransitionProof memory _input)
        public
        pure
        returns (bytes32)
    {
