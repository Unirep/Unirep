...
import { IncrementalQuinTree, SparseMerkleTreeImpl, Identity } from '@unirep/crypto';
...
declare const genNewEpochTree: (deployEnv?: string) => Promise<SparseMerkleTreeImpl>;
...
declare const genNewGST: (GSTDepth: number, USTDepth: number) => IncrementalQuinTree;
declare const genNewUserStateTree: (deployEnv?: string) => Promise<SparseMerkleTreeImpl>;
...
declare const genReputationCircuitInput: (id: Identity, epoch: number, nonce: number, GSTree: IncrementalQuinTree, leafIdx: number, reputationRecords: any, attesterId: any, _repNullifiersAmount?: any, _minRep?: any, _proveGraffiti?: any, _graffitiPreImage?: any) => Promise<any>;
declare const genProveSignUpCircuitInput: (id: Identity, epoch: number, GSTree: IncrementalQuinTree, leafIdx: number, reputationRecords: any, attesterId: any, _signUp?: number | undefined) => Promise<any>;
