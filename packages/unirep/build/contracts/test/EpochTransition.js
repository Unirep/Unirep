...
describe('Epoch Transition', function () {
    ...
    before(async () => {
        ...
        const tree = new crypto_1.IncrementalQuinTree(config_1.circuitGlobalStateTreeDepth, ZERO_VALUE, 2);
    ...
    it('bootstrap user state and reputations and bootstrap global state tree', async () => {
        ...
        // Global state tree
        GSTree = new crypto_1.IncrementalQuinTree(config_1.circuitGlobalStateTreeDepth, utils_1.GSTZERO_VALUE, 2);
