...
import { SparseMerkleTreeImpl, SnarkBigInt, Identity, SnarkProof, IncrementalQuinTree } from '@unirep/crypto';
...
declare const genNewEpochTree: (_epochTreeDepth?: number) => Promise<SparseMerkleTreeImpl>;
...
declare const genNewUserStateTree: (_userStateTreeDepth?: number) => Promise<SparseMerkleTreeImpl>;
...
declare const genEpochKeyCircuitInput: (id: Identity, tree: IncrementalQuinTree, leafIndex: number, ustRoot: BigInt, epoch: number, nonce: number) => any;
declare const genStartTransitionCircuitInput: (id: Identity, tree: IncrementalQuinTree, leafIndex: number, ustRoot: BigInt, epoch: number, nonce: number) => any;
