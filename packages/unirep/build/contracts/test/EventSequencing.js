...
describe('EventSequencing', () => {
    ...
    before(async () => {
        ...
        let epochKeyNonce = 0;
        let epochKey = (0, utils_1.genEpochKey)(userIds[0].identityNullifier, currentEpoch.toNumber(), epochKeyNonce);
        const proof = [];
        for (let i = 0; i < 8; i++) {
            proof.push('0');
        }
        ...
        epochKeyNonce = 0;
        epochKey = (0, utils_1.genEpochKey)(userIds[1].identityNullifier, currentEpoch.toNumber(), epochKeyNonce);
