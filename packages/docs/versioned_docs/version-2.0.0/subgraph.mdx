...
export const NetworkURL = {
    ...
    OptimismSepolia: urlBase + '/optimism-sepolia/v' + contractVersion,
    ArbitrumSepolia: urlBase + '/arbitrum-sepolia/v' + contractVersion,
...
<table>
    ...
    <tr>
        ...
        <td>
            <a href={`${NetworkURL.ArbitrumSepolia}`}>
                {NetworkURL.ArbitrumSepolia}
            </a>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <a href={`${NetworkURL.OptimismSepolia}`}>
                {NetworkURL.OptimismSepolia}
            </a>
        </td>
    </tr>
    <tr>
