...
Clicking the **Join** button prompts the client to generate a [Semaphore Identity](https://semaphore.pse.dev/) and a [signup proof](circuits-api/circuits.md#signup-proof).
