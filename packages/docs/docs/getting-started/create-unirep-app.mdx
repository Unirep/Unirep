...
:::info
See [`EpochKeyVerifierHelper`](contracts-api/epoch-key-verifier-helper.md) to learn how to deploy a verifier and its APIs.
:::
...
`EpochKeyVerifierHelper.sol` provides [`decodeEpochKeySignals`](contracts-api/epoch-key-verifier-helper.md#decodeepochkeysignals) to fix this problem.
