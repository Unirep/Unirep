...
**Provable Data**<br/>
Displays only [provable data](#provable-data ) that the user can currently prove ownership of. Any change made to the user's data since their last [user state transition](protocol/user-state-transition.md) is not included here. This is updated **after** UST is performed.
...
- A *sum field* carries a total of all the data that has been added to it.
- A *replacement field* is used to fully replace old data with new data.
