...
After epoch ends, the user should perform [user state transition](../protocol/user-state-transition.md) to finalize the state in the previous epoch, and use a new state to receive more data in a new epoch.<br/>
