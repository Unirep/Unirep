...
## What is an Attester?
* An [Attester](./protocol/users-and-attesters.md), technically, is the smart contract or an EOA (Externally Owned Account) that you will create as part of building out the application. The smart contract will be responsible for, literally, attesting the data to the anonymous user. 
...
## What can I buidl with Unirep?

* Please check the examples here: [🤠  Design & Deploy a customized attester](./welcome#application-built-by-our-core-contributors).
...
* Refer to our [Getting started with create-unirep-app](./getting-started/create-unirep-app) or [Getting started with typescript/javascript](./getting-started/ts-js) section for how to bootstrap a UniRep application.
