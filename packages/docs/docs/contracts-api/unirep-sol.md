...
Sign up a new user by manually supplying an identity commitment and state tree leaf. This is designed to be used by applications that want custom signup proofs.
