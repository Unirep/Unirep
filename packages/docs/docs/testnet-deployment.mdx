...
export const coreVersion = require('../../core/package.json').version
export const contractsVersion = require('../../contracts/package.json').version
export const circuitsVersion = require('../../circuits/package.json').version
export const utilsVersion = require('../../utils/package.json').version
