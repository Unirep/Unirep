...
Object.defineProperty(exports, 'formatProofForSnarkjsVerification', {
    enumerable: true,
    get: function () {
        return circuits_1.formatProofForSnarkjsVerification
    },
})
...
const computeEmptyUserStateRoot = (treeDepth) => {
    const t = new crypto_1.IncrementalMerkleTree(
        treeDepth,
...
const computeInitUserStateRoot = async (treeDepth, leafIdx, airdropPosRep) => {
    const t = await crypto_1.SparseMerkleTree.create(
        new keyv_1.default(),
        treeDepth,
        defaultUserStateLeaf
    )
    if (leafIdx && airdropPosRep) {
        const airdropReputation = new UserState_1.Reputation(
...
const genEpochKey = (
    ...
    const values = [identityNullifier, epoch, nonce, BigInt(0), BigInt(0)]
...
const genNewSMT = async (treeDepth, defaultLeafHash) => {
    return crypto_1.SparseMerkleTree.create(
        new keyv_1.default(),
        treeDepth,
        defaultLeafHash
    )
...
const verifyEpochKeyProofEvent = async (event) => {
    var _a
    const args =
        (_a = event === null || event === void 0 ? void 0 : event.args) ===
            null || _a === void 0
            ? void 0
            : _a._proof
    const emptyArray = []
    const formatPublicSignals = emptyArray
        .concat(
            args === null || args === void 0 ? void 0 : args.globalStateTree,
            args === null || args === void 0 ? void 0 : args.epoch,
            args === null || args === void 0 ? void 0 : args.epochKey
        )
        .map((n) => BigInt(n))
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(
        args === null || args === void 0 ? void 0 : args.proof
    )
    const isProofValid = await (0, circuits_1.verifyProof)(
...
const verifyReputationProofEvent = async (event) => {
    ...
    const formatPublicSignals = emptyArray
        .concat(
            args === null || args === void 0 ? void 0 : args.repNullifiers,
            args === null || args === void 0 ? void 0 : args.epoch,
            args === null || args === void 0 ? void 0 : args.epochKey,
            args === null || args === void 0 ? void 0 : args.globalStateTree,
            args === null || args === void 0 ? void 0 : args.attesterId,
            args === null || args === void 0
                ? void 0
                : args.proveReputationAmount,
            args === null || args === void 0 ? void 0 : args.minRep,
            args === null || args === void 0 ? void 0 : args.proveGraffiti,
            args === null || args === void 0 ? void 0 : args.graffitiPreImage
        )
        .map((n) => BigInt(n))
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(
        args === null || args === void 0 ? void 0 : args.proof
...
const verifySignUpProofEvent = async (event) => {
    ...
    const formatPublicSignals = emptyArray
        .concat(
            ...
            args === null || args === void 0 ? void 0 : args.globalStateTree,
            args === null || args === void 0 ? void 0 : args.attesterId,
            args === null || args === void 0 ? void 0 : args.userHasSignedUp
        )
        .map((n) => BigInt(n))
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(
        args === null || args === void 0 ? void 0 : args.proof
...
const verifyStartTransitionProofEvent = async (event) => {
    ...
    const formatPublicSignals = emptyArray
        .concat(
            args === null || args === void 0 ? void 0 : args._blindedUserState,
            args === null || args === void 0 ? void 0 : args._blindedHashChain,
            args === null || args === void 0 ? void 0 : args._globalStateTree
        )
        .map((n) => BigInt(n))
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(
        args === null || args === void 0 ? void 0 : args._proof
    )
    const isProofValid = await (0, circuits_1.verifyProof)(
...
const verifyUserStateTransitionEvent = async (event) => {
    ...
    let formatPublicSignals = emptyArray
        ...
        .map((n) => BigInt(n))
    let formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(
...
const verifyUSTEvents = async (
    ...
    const transitionArgs =
        (_a =
            transitionEvent === null || transitionEvent === void 0
                ? void 0
                : transitionEvent.args) === null || _a === void 0
            ? void 0
            : _a._proof
...
const verifyProcessAttestationEvents = async (
    processAttestationEvents,
    startBlindedUserState,
    finalBlindedUserState
) => {
    var _a
    ...
    for (let i = 0; i < processAttestationEvents.length; i++) {
        const args =
            (_a = processAttestationEvents[i]) === null || _a === void 0
                ? void 0
                : _a.args
...
const genUnirepStateFromParams = (_unirepState) => {
    ...
    for (let key in _unirepState.latestEpochKeyToAttestationsMap) {
        ...
        for (const attestation of _unirepState.latestEpochKeyToAttestationsMap[
            ...
            const attestClass = new UnirepState_1.Attestation(
    ...
    const unirepState = new UnirepState_1.UnirepState(
...
const genUnirepStateFromContract = async (provider, address, _unirepState) => {
    ...
    const unirepContract = await (0, contracts_1.getUnirepContract)(
        address,
        provider
    )
    let unirepState
    ...
    const latestBlock =
        _unirepState === null || _unirepState === void 0
            ? void 0
            : _unirepState.latestProcessedBlock
    const startBlock =
        latestBlock != undefined
            ? latestBlock + 1
            : defaults_1.DEFAULT_START_BLOCK
    ...
    for (let i = 0; i < sequencerEvents.length; i++) {
        ...
        const occurredEvent =
            (_b = sequencerEvent.args) === null || _b === void 0
                ? void 0
                : _b._event
        if (occurredEvent === contracts_1.Event.UserSignedUp) {
            ...
            const args =
                signUpEvent === null || signUpEvent === void 0
                    ? void 0
                    : signUpEvent.args
            const epoch = Number(
                args === null || args === void 0 ? void 0 : args._epoch
            )
            const commitment = BigInt(
                args === null || args === void 0
                    ? void 0
                    : args._identityCommitment
            )
            const attesterId = Number(
                args === null || args === void 0 ? void 0 : args._attesterId
            )
            const airdrop = Number(
                args === null || args === void 0 ? void 0 : args._airdropAmount
            )
            ...
            const args =
                attestationSubmittedEvent === null ||
                attestationSubmittedEvent === void 0
                    ? void 0
                    : attestationSubmittedEvent.args
            const epoch = Number(
                args === null || args === void 0 ? void 0 : args._epoch
            )
            const toProofIndex = Number(
                args === null || args === void 0 ? void 0 : args.toProofIndex
            )
            const fromProofIndex = Number(
                args === null || args === void 0 ? void 0 : args.fromProofIndex
            )
            const attestation_ =
                args === null || args === void 0 ? void 0 : args._attestation
            const event = proofIndexMap[toProofIndex]
            const results =
                (_c =
                    event === null || event === void 0
                        ? void 0
                        : event.args) === null || _c === void 0
                    ? void 0
                    : _c._proof
            if (isProofIndexValid[toProofIndex] === undefined) {
                ...
                if (
                    (args === null || args === void 0
                        ? void 0
                        : args._event) ===
                    contracts_1.AttestationEvent.SpendReputation
                ) {
                    let validNullifier = true
                    const nullifiers =
                        results === null || results === void 0
                            ? void 0
                            : results.repNullifiers.map((n) => BigInt(n))
            ...
            if (fromProofIndex && isProofIndexValid[fromProofIndex]) {
                ...
                if (
                    (fromEvent === null || fromEvent === void 0
                        ? void 0
                        : fromEvent.event) !== 'IndexedReputationProof'
                ) {
                    console.log(
                ...
                const proveReputationAmount = Number(
                    (_e =
                        (_d =
                            fromEvent === null || fromEvent === void 0
                                ? void 0
                                : fromEvent.args) === null || _d === void 0
                            ? void 0
                            : _d._proof) === null || _e === void 0
                        ? void 0
                        : _e.proveReputationAmount
                )
            ...
            if (
                ...
                // update attestation
                const attestation = new UnirepState_1.Attestation(
                ...
                const epochKey =
                    args === null || args === void 0 ? void 0 : args._epochKey
                if (
                    epochKey.eq(
                        results === null || results === void 0
                            ? void 0
            ...
            const epoch =
                (_f = epochEndedEvent.args) === null || _f === void 0
                    ? void 0
                    : _f._epoch.toNumber()
            ...
            const args =
                userStateTransitionedEvent === null ||
                userStateTransitionedEvent === void 0
                    ? void 0
                    : userStateTransitionedEvent.args
            const epoch = Number(
                args === null || args === void 0 ? void 0 : args._epoch
            )
            const newLeaf = BigInt(
                args === null || args === void 0 ? void 0 : args._hashedLeaf
            )
            const proofIndex = Number(
                args === null || args === void 0 ? void 0 : args._proofIndex
            )
            ...
            const proofArgs =
                (_g =
                    event === null || event === void 0
                        ? void 0
                        : event.args) === null || _g === void 0
                    ? void 0
                    : _g._proof
            const fromEpoch = Number(
                proofArgs === null || proofArgs === void 0
                    ? void 0
                    : proofArgs.transitionFromEpoch
            )
            if (isProofIndexValid[proofIndex] === undefined) {
                ...
                const proofIndexes =
                    (_h =
                        event === null || event === void 0
                            ? void 0
                            : event.args) === null || _h === void 0
                        ? void 0
                        : _h._proofIndexRecords.map((n) => Number(n))
                const startTransitionEvent = proofIndexMap[proofIndexes[0]]
                if (
                    startTransitionEvent === undefined ||
                    (startTransitionEvent === null ||
                    startTransitionEvent === void 0
                        ? void 0
                ...
                for (let j = 1; j < proofIndexes.length; j++) {
                    ...
                    if (
                        ...
                        (processAttestationEvent === null ||
                        processAttestationEvent === void 0
                            ? void 0
            ...
            if (isProofIndexValid[proofIndex]) {
                const epkNullifiersInEvent =
                    (_j =
                        proofArgs === null || proofArgs === void 0
                            ? void 0
                            : proofArgs.epkNullifiers) === null || _j === void 0
                        ? void 0
                        : _j.map((n) => BigInt(n))
                let exist = false
...
const genUserStateFromParams = (userIdentity, _userState) => {
    ...
    for (const key in _userState.latestUserStateLeaves) {
        ...
        const leaf = {
            ...
            reputation: new UserState_1.Reputation(
    ...
    const userState = new UserState_1.UserState(
        unirepState,
        userIdentity,
...
const genUserStateFromContract = async (
    ...
    const latestBlock =
        unirepState === null || unirepState === void 0
            ? void 0
            : unirepState.latestProcessedBlock
    const startBlock =
        latestBlock != undefined
            ? latestBlock + 1
            : defaults_1.DEFAULT_START_BLOCK
