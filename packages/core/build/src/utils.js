...
const computeEmptyUserStateRoot = (treeDepth) => {
    const t = new crypto_1.IncrementalMerkleTree(treeDepth, defaultUserStateLeaf, 2);
    return t.root;
};
...
const genNewSMT = async (treeDepth, defaultLeafHash) => {
    return crypto_1.SparseMerkleTree.create(new keyv_1.default(), treeDepth, defaultLeafHash);
};
...
const verifyEpochKeyProofEvent = async (event) => {
    ...
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args.globalStateTree, args === null || args === void 0 ? void 0 : args.epoch, args === null || args === void 0 ? void 0 : args.epochKey)
        .map((n) => BigInt(n));
...
const verifyReputationProofEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args.repNullifiers, args === null || args === void 0 ? void 0 : args.epoch, args === null || args === void 0 ? void 0 : args.epochKey, args === null || args === void 0 ? void 0 : args.globalStateTree, args === null || args === void 0 ? void 0 : args.attesterId, args === null || args === void 0 ? void 0 : args.proveReputationAmount, args === null || args === void 0 ? void 0 : args.minRep, args === null || args === void 0 ? void 0 : args.proveGraffiti, args === null || args === void 0 ? void 0 : args.graffitiPreImage)
        .map((n) => BigInt(n));
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(args === null || args === void 0 ? void 0 : args.proof);
...
const verifySignUpProofEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args.epoch, args === null || args === void 0 ? void 0 : args.epochKey, args === null || args === void 0 ? void 0 : args.globalStateTree, args === null || args === void 0 ? void 0 : args.attesterId, args === null || args === void 0 ? void 0 : args.userHasSignedUp)
        .map((n) => BigInt(n));
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(args === null || args === void 0 ? void 0 : args.proof);
...
const verifyStartTransitionProofEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args._blindedUserState, args === null || args === void 0 ? void 0 : args._blindedHashChain, args === null || args === void 0 ? void 0 : args._globalStateTree)
        .map((n) => BigInt(n));
...
const verifyProcessAttestationEvent = async (event) => {
    ...
    const emptyArray = [];
    const formatPublicSignals = emptyArray
        .concat(args === null || args === void 0 ? void 0 : args._outputBlindedUserState, args === null || args === void 0 ? void 0 : args._outputBlindedHashChain, args === null || args === void 0 ? void 0 : args._inputBlindedUserState)
        .map((n) => BigInt(n));
    const formatProof = (0, circuits_1.formatProofForSnarkjsVerification)(args === null || args === void 0 ? void 0 : args._proof);
...
const verifyUserStateTransitionEvent = async (event) => {
    ...
    let formatPublicSignals = emptyArray
        .concat(transitionArgs.newGlobalStateTreeLeaf, transitionArgs.epkNullifiers, transitionArgs.transitionFromEpoch, transitionArgs.blindedUserStates, transitionArgs.fromGlobalStateTree, transitionArgs.blindedHashChains, transitionArgs.fromEpochTree)
        .map((n) => BigInt(n));
...
const genUnirepStateFromContract = async (provider, address, _unirepState) => {
    ...
    for (let i = 0; i < sequencerEvents.length; i++) {
        ...
        if (occurredEvent === contracts_1.Event.UserSignedUp) {
            ...
            if (isProofIndexValid[toProofIndex] &&
            ...
            if (isProofIndexValid[proofIndex] === undefined) {
                ...
                if (startTransitionEvent === undefined ||
                    (startTransitionEvent === null || startTransitionEvent === void 0 ? void 0 : startTransitionEvent.event) !==
                ...
                for (let j = 1; j < proofIndexes.length; j++) {
                    ...
                    if (processAttestationEvent === undefined ||
                        (processAttestationEvent === null || processAttestationEvent === void 0 ? void 0 : processAttestationEvent.event) !==
