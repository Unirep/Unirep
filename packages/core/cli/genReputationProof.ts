...
import { genReputationNullifier, genUserStateFromContract, maxReputationBudget } from '../src'
...
const genReputationProof = async (args: any) => {
    ...
    const graffitiPreImage = args.graffiti_preimage != null ? BigInt(args.graffiti_preimage) : BigInt(0)
