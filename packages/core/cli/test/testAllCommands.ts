...
describe('test all CLI subcommands', function() {
    ...
    describe('genUserIdentity CLI subcommand', () => {
        it('should generate an identity for user', async () => {
            ...
            const _userIdentity = new ZkIdentity(Strategy.SERIALIZED, serializedIdentity)
            ...
            const _userIdentityCommitment = _userIdentity.genIdentityCommitment()
            expect(serializedIdentityCommitment).equal(_userIdentityCommitment.toString())
