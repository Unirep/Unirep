import { genIdentity, genIdentityCommitment, hash5, hashLeftRight, IncrementalQuinTree, SparseMerkleTreeImpl } from "@unirep/crypto";
import { expect } from "chai";
import * as path from 'path';

import { Circuit, executeCircuit, getSignalByName } from "../circuits/utils";
import { circuitGlobalStateTreeDepth, startTransitionCircuitPath } from "../config/";
import { bootstrapRandomUSTree, compileAndLoadCircuit, genProofAndVerify, genStartTransitionCircuitInput } from './utils';
...
describe('User State Transition circuits', function () {
  ...
  describe('Start User State Transition', () => {
    ...
    const GSTZERO_VALUE = 0; let GSTree: IncrementalQuinTree;
