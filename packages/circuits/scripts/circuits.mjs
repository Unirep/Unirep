...
export const circuitContents = {
    ...
    epochKeyMulti: `pragma circom 2.0.0; include "../circuits/epochKeyMulti.circom"; \n\ncomponent main { public [ data ] } = EpochKeyMulti(${STATE_TREE_DEPTH}, ${EPOCH_TREE_DEPTH}, ${EPOCH_TREE_ARITY}, ${NUM_EPOCH_KEY_NONCE_PER_EPOCH});`,
